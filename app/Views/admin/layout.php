   ...
   <div class="h-full px-3 pb-4 overflow-y-auto bg-white dark:bg-gray-800">
      ...
      <ul class="space-y-2 font-medium">
         <?php foreach($sidebar as $key => $a) : ?>
            <?php if(in_array($auth->role, $a['role'])) : ?>
         <li>
...
<div class="p-4 sm:ml-64">
   <div class="p-4 mt-14 dark:text-gray-100">
      ...
      <?php if(session()->get("passwordValidate")) : ?>
         <div id="alert-border-2" class="flex items-center p-4 mb-4 text-yellow-800 border-t-4 border-yellow-300 bg-yellow-50 dark:text-yellow-400 dark:bg-gray-800 dark:border-yellow-800" role="alert">
            <svg class="flex-shrink-0 w-4 h-4" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
               <path d="M10 .5a9.5 9.5 0 1 0 9.5 9.5A9.51 9.51 0 0 0 10 .5ZM9.5 4a1.5 1.5 0 1 1 0 3 1.5 1.5 0 0 1 0-3ZM12 15H8a1 1 0 0 1 0-2h1v-3H8a1 1 0 0 1 0-2h2a1 1 0 0 1 1 1v4h1a1 1 0 0 1 0 2Z"/>
            </svg>
            <div class="ms-3 text-sm font-medium">
              Password Anda terlalu lemah, segera ganti untuk menghindari keamanan data <a href="#" class="font-semibold underline hover:no-underline">update password</a>.
            </div>
